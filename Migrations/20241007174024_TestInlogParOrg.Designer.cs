...
namespace EventSpotterWeb.Migrations
{
    ...
    [Migration("20241007174024_TestInlogParOrg")]
    partial class TestInlogParOrg
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1,
                            Amount = 50.00m,
                            PaymentDate = new DateTime(2024, 10, 7, 19, 40, 23, 417, DateTimeKind.Local).AddTicks(3909),
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentID = 1,
                            PaymentStatus = "Completed",
                            ReservationDate = new DateTime(2024, 10, 7, 19, 40, 23, 417, DateTimeKind.Local).AddTicks(3987),
                            TotalPrice = 50.00m
                        });
                });
