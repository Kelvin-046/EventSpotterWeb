...
namespace EventSpotterWeb.Migrations
{
    ...
    partial class DatabaseEventSpotterModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1,
                            Amount = 50.00m,
                            PaymentDate = new DateTime(2024, 10, 9, 12, 6, 46, 852, DateTimeKind.Local).AddTicks(5219),
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentID = 1,
                            PaymentStatus = "Completed",
                            ReservationDate = new DateTime(2024, 10, 9, 12, 6, 46, 852, DateTimeKind.Local).AddTicks(5298),
                            TotalPrice = 50.00m
                        });
                });
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Organizer", b =>
                {
                    b.HasOne("EventSpotterWeb.Models.Account", "Accounts")
                        .WithMany("Organizers")
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Participant", b =>
                {
                    b.HasOne("EventSpotterWeb.Models.Account", "Account")
