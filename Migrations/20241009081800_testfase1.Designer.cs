...
namespace EventSpotterWeb.Migrations
{
    ...
    [Migration("20241009081800_testfase1")]
    partial class testfase1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1,
                            Amount = 50.00m,
                            PaymentDate = new DateTime(2024, 10, 9, 10, 17, 59, 785, DateTimeKind.Local).AddTicks(9677),
            ...
            modelBuilder.Entity("EventSpotterWeb.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentID = 1,
                            PaymentStatus = "Completed",
                            ReservationDate = new DateTime(2024, 10, 9, 10, 17, 59, 785, DateTimeKind.Local).AddTicks(9801),
                            TotalPrice = 50.00m
                        });
                });
